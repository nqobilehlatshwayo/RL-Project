...
def main():
    ...
    # Define optimizer builder function that accepts lr parameter
    def optimizer_builder(params, lr=config["learning_rate"]):
        return optim.SGD(params, lr=lr, momentum=config["momentum"])
    ...
    model = DQN(
        ...
        policy_kwargs={"optimizer_class": optimizer_builder}
    )
